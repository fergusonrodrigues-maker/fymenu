...
type Tab = "cozinha" | "garcom" | "andamento";
...
export default function RestaurantOperationsModal({ unitId }: { unitId: string }) {
  ...
  return (
    <div>
      ...
      {tab === "garcom" && (
        <GarcomTab orders={orders} onUpdateWaiter={updateWaiterStatus} />
      )}
      {tab === "andamento" && (
