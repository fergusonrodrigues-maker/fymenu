...
type ReportProduct = { name: string; qty: number; revenue: number };
type ReportPayments = { cash: number; card: number; pix: number };
...
function FinanceiroModal({ unit, analytics, reportData }: {
  unit: Unit | null;
