...
export type Unit = { id: string; name: string; slug: string; custom_domain: string | null; address: string; city: string | null; neighborhood: string | null; whatsapp: string | null; instagram: string | null; logo_url: string | null; cover_url: string | null; description: string | null; maps_url: string | null; delivery_link: string | null; is_published: boolean; comanda_close_permission: "garcom_e_caixa" | "somente_caixa"; daily_revenue_goal?: number | null; facebook_pixel_id?: string | null; ifood_url?: string | null; ifood_platform?: string | null; business_hours?: any[] | null; force_status?: string | null };
